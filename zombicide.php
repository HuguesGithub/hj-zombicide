...
session_start([]);
include_once PLUGIN_PATH.'src/Controller/UtilitiesController.php';

/**
 * Plugin Name: HJ - Zombisite
 * Description: News Zombisite New
 * @author Hugues
 * @since 1.00.01.01
 */
class Zombisite
{
    ...
    public function templateLoader()
    {
        ...
        return PLUGIN_PATH.'templates/base.tpl';
        return $bean->getRender('templates/base.tpl', $attributes);
    }
}
...
function zombisiteAutoloader(string $classname)
{
...
function dealWithAjax_callback(): void
{
